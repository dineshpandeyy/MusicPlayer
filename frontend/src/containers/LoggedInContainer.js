...
const LoggedInContainer = ({children}) => {
    ...
    const togglePlayPause = () => {
        if (isPaused) {
            playSound(
                "https://res.cloudinary.com/deq8p7m7b/video/upload/v1711867836/plg9sjtuosxzvxk0jjyy.wav"
            );
            setIsPaused(false);
        } else {
            pauseSound();
    ...
    return (
        <div className="h-full w-full bg-black">
            <div className="h-9/10 w-full bg-black flex">
            ...
            <div className="w-full h-1/10 bg-black bg-opacity-30 text-white flex items-center px-4">
                ...
                <div className="w-1/4 flex justify-end">Progress Bar Here</div>
            </div>
        </div>
    );
};
